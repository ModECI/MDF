...
def create_example_node(node_id, graph):
    ...
    f1 = Function(id='logistic_1', function='logistic', args={'variable0':ip1.id,'gain':'logistic_gain','bias':0,'offset':0})
    a.functions.append(f1)
    f2 = Function(id='linear_1', function='linear', args={'variable0':f1.id,'slope':'slope','intercept':'intercept'})
