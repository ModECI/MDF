...
with open('MDF_function_specifications.md','w') as d:
    d.write('# Specification of standard functions in ModECI v%s\n'%MODECI_MDF_VERSION)
    d.write('%s\n'%comment)


    d.write('These functions are defined in https://github.com/ModECI/MDF/blob/main/src/modeci_mdf/standard_functions.py\n')
