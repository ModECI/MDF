...
class LCAModel(torch.nn.Module):
    ...
    def forward(self, input: torch.Tensor) -> Tuple[torch.Tensor, torch.Tensor]:
        ...
        Args:
            input: A vector specifying the feed forward input for each accumulator. This is typically a representation
                of the stimulus, task, or both.

        Returns:
            A tuple with to vectors, the activations before and after applying the non-linear activation function.
        """
        dev = "cuda:0"
