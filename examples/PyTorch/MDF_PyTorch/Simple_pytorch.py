"""
This script has been generated by modeci_mdf v0.4.5.
...
class Model(nn.Module):
	def __init__(self,input_node, processing_node, ):
		super().__init__()
...
dummy_input =torch.tensor(0.5,)
output = model(dummy_input)
torch.onnx.export(model,dummy_input,'Simple.onnx',verbose=True,input_names=[],opset_version=9)
