...
if len(sys.argv) >= 1:
    ...
    if model_name not in get_model_names("."):
        ...
        print("***Note***: The larger the count the greater the run time, keep count within 10 - 50 range")
        sys.exit(1)
    try:
        ...
        if not get_pytorch_model:
            ...
            print("Modify the file to be benchmarked as such:\n"
        ...
        print(f"Could not import module '{model_name}'. Make sure the module exists and is properly defined.")
        sys.exit(1)
