...
if __name__ == "__main__":
    ...
    f1 = Function(id='linear_func', function='linear', args={'variable0':ip1.id,'slope':'slope','intercept':'intercept'})
    ...
    f1 = Function(id='logistic_func', function='logistic', args={'variable0':ip1.id,'gain':'gain','bias':'bias','offset':'offset'})
    ...
    c.parameters = {'scale':abcd.C_scale,'rate':abcd.C_rate,'bias':abcd.C_bias,'offset':abcd.C_offset}
    ip1 = InputPort(id='input_port1', shape='(1,)')
    c.input_ports.append(ip1)

    f1 = Function(id='exponential_func', function='exponential', args={'variable0':ip1.id,'scale':'scale','rate':'rate','bias':'bias','offset':'offset'})
    ...
    f1 = Function(id='sin_func', function='sin', args={'variable0':ip1.id,'scale':'scale'})
