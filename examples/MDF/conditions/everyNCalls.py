...
def main():
    ...
    cond_b = Condition(type="EveryNCalls", dependencies=a.id, n=2) #B executes every 2 calls of A
    cond_c = Condition(type="EveryNCalls", dependencies=b.id, n=3) #C executes every 3 calls of B
