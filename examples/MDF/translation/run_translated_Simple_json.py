...
def main():
    ...
    if "-run" in sys.argv:
        ...
        print("Old file output value>>>",eg.enodes['processing_node'].evaluable_outputs['output_1'].curr_value)

        print("New file output value>>>",eg_old.enodes['processing_node'].evaluable_outputs['output_1'].curr_value)
