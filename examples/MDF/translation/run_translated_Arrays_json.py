...
def main():
    ...
    if "-run" in sys.argv:
        ...
        print("New file output value>>>",eg.enodes['middle_node'].evaluable_outputs['output_1'].curr_value)

        print("Old file output value>>>",eg_old.enodes['middle_node'].evaluable_outputs['output_1'].curr_value)
