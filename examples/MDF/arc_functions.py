...
def main():
    ...
    arctan_node.parameters.append(
        Parameter(id="input_value", value=1.0)
    )  # Example input
    arctan_node.parameters.append(
        Parameter(
            id="arctan_result",
    ...
    print(
        "arctan_node output:",
        eg.enodes["arctan_node"].evaluable_outputs["output"].curr_value,
    )
    print(
        "arccos_node output:",
        eg.enodes["arccos_node"].evaluable_outputs["output"].curr_value,
    )
    print(
        "arcsin_node output:",
        eg.enodes["arcsin_node"].evaluable_outputs["output"].curr_value,
    )
