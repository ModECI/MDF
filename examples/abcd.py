...
def main():
    ...
    f1 = Function(id='linear_func', function='linear',
    ...
    f1 = Function(id='logistic_func', function='logistic',
    ...
    f1 = Function(id='exponential_func', function='exponential',
                  args={'variable0': ip1.id, 'scale': 'scale', 'rate': 'rate', 'bias': 'bias', 'offset': 'offset'})
