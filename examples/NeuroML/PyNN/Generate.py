...
def generate(ref, num_pop0=2, num_pop1=2, input_percentage=50, input_weight='.8'):
    ...
    net.inputs.append(
        Input(id="stim", input_source=input_source.id, population=p0.id, percentage=input_percentage, weight=input_weight)
    )
...
if __name__ == "__main__":
    ...
    if "-one" in sys.argv:
        ...
        sim, net = generate("InputWeights", num_pop0=4, num_pop1=0, input_percentage=62, input_weight='.7')
    else:
