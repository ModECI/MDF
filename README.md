...
## Installation 
To install the package and run it locally:<br/>
1. Clone the repo (giving the commad: git clone (link) to your terminal)   
2. Change the directory (using: cd MDF)  
3. Create virtual environment (sequence of commands: pip install virtualenv, virtualenv mdf-env)  
4. Activate virtual environment (using: source MDF-env/bin/activate)  
5. Download the package (using: pip install .)
